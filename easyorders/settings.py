...
# and README.rst, a easyorders directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'easyorders')
...
SECRET_KEY = 'r)#sy80lrwdry3y3z!2@szdz!0u59wbwx7p)pe#fw)o$+495ub'
